...
// 
namespace GraphLabs.Components.UserActionsRegistrator {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserActionsRegistratorClient : System.ServiceModel.ClientBase<GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator>, GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator {
        ...
        protected override GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator CreateChannel() {
            return new UserActionsRegistratorClientChannel(this);
        }
        
        private class UserActionsRegistratorClientChannel : ChannelBase<GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator>, GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator {
            
            public UserActionsRegistratorClientChannel(System.ServiceModel.ClientBase<GraphLabs.Components.UserActionsRegistrator.IUserActionsRegistrator> client) : 
                    base(client) {
            }
